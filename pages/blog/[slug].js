    ...
    return (
        <Layout title={frontmatter.title}>
            ...
            <div className="w-full px-10 py6 bg-white rounded-lg shadow-md mt-6">
                ...
                <img src={frontmatter.cover_image} alt="" className="w-full rounded mt-4"/>
                <div className="flex justify-between items-center bg-gray-100 p-2 my-8">
                    <div className="flex items-center">
                        <img src={frontmatter.author_image} alt="" className="mx-4
                        w-10 h-10 object-cover rounded-full hidden sm:block"/>
